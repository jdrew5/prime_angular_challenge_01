...
var pg = require('pg');
var connectionString = process.env.DATABASE_URL || 'postgres://localhost:5432/prime_angular_challenge_01';
...
app.get('/data', function(req,res){
    ...
    pg.connect(connectionString, function (err, client, done) {
        ...
        var query = client.query("SELECT name, location, favorite_number FROM person");
